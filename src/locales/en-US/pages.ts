export default {
  ...
  'pages.banner.add.bannerUrl': 'Banner URL',
  'pages.banner.add.exlink': 'external link',
  'pages.layouts.userLayout.title': 'Bounce Manager',
  ...
  'pages.login.loadingStatusMessge.await': 'Please Login',
  'pages.login.loadingStatusMessge.loading': 'Please Sign',
  'pages.login.loadingStatusMessge.login-success': '🎉 🎉 🎉  Login Success！',
  'pages.login.loadingStatusMessge.login-fail': 'login fail',
  'pages.login.loadingStatusMessge.account-fail': 'get account fail',
  'pages.login.retry': 'retry',
  'pages.getCaptchaSecondText': 'sec(s)',
  'pages.login.rememberMe': 'Remember me',
  'pages.login.forgotPassword': 'Forgot Password ?',
  'pages.login.submit': 'Submit',
  'pages.login.address.submit': 'Connect MetaMask to Login',
  'pages.login.loginWith': 'Login with :',
  'pages.login.registerAccount': 'Register Account',
  'pages.login.successfully': '🎉 🎉 🎉  Login Success！',
  ...
  'pages.account.hideCreationButton': '{v} Creation',
  'pages.account.disableButton': '{v} User',
  'pages.account.hideCreation': 'Are you sure you want to {v} this user’s all creations on Fangible?',
  'pages.account.Disable': 'Are you sure you want to {v} this user’s actions on Fangible？',
};
