export default {
  ...
  'pages.banner.add.bannerUrl': '轮播图',
  'pages.banner.add.exlink': '外链',
  ...
  'pages.login.address.submit': '连接MetaMask钱包登陆',
  'pages.login.loginWith': '其他登录方式 :',
  'pages.login.registerAccount': '注册账户',
  'pages.login.successfully': '🎉 🎉 🎉  登录成功！',
  'pages.login.loadingStatusMessge.await': '等待连接中',
  'pages.login.loadingStatusMessge.loading': '连接钱包中，等待授权',
  'pages.login.loadingStatusMessge.login-success': '🎉 🎉 🎉  登录成功！',
  'pages.login.loadingStatusMessge.login-fail': '登录失败！',
  'pages.login.loadingStatusMessge.account-fail': '授权失败，请重新授权',
  'pages.login.retry': '重新授权',
